...
Assignments are due by **midnight** on the due date (for example, the first pair assignment is due at 11:59 pm on 4 March). When you have completed the assignment, email me the GitHub tag URL for the final version of your assignment.
...
#### [Slides](https://cdn.rawgit.com/HertieDataScience/SyllabusAndLectures/master/LectureSlides/Lecture3/Lecture3.html)
